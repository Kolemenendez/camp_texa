...
# run bwa mem
/home/kmenende/anaconda3/bin/bwa mem -t 8 ${refgenome} \
...
/home/kmenende/anaconda3/bin/samtools view -b -f 2 \
...
~/anaconda3/bin/picard \
AddOrReplaceReadGroups I=${workdir}/01_bam_files/${basename_array}_cleaned_sorted.ba$
...
# remove duplicates to sorted, cleaned, and read grouped bam file (creates final bam$
~/anaconda3/bin/picard \
...
/home/kmenende/anaconda3/bin/samtools index ${workdir}/01_bam_files/${basename_array$
