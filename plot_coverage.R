# you must have this in the same place you have your depth script
...
rm(a_rep)
save.image("camptexa_coverage.RData")



load("camptexa_coverage.RData")

par(mfrow=c(4,6))
for(a in 1:length(output2)) {
        plot(0:51, output2[[a]], pch=19, cex=0.1, xlab="Coverage", ylab="Proportion $
